...
class FilmaYouTubePlayerView(
  ...
  fun loadVideo(videoId: String?) {
    ...
    // YouTube requires embedded WebView clients to identify themselves with an
    // HTTPS Referer derived from the installed app ID. Keep the official player
    // intact: FILMA does not intercept media URLs or cover YouTube controls.
